...
class AuthControllerTest {
    ...
    class Register {
        ...
        void whenEmailAvailable_thenReturns200() throws Exception {
            ...
            String jsonPayload = "{\"email\":\"new@moodbites.com\",\"password\":\"pass123\",\"name\":\"New User\",\"fcmToken\":\"fcm\"}";
        ...
        void whenEmailTaken_thenReturns409() throws Exception {
            ...
            String jsonPayload = "{\"email\":\"taken@moodbites.com\",\"password\":\"pass123\",\"name\":\"User\",\"fcmToken\":\"fcm\"}";
    ...
    class GetProfile {
        ...
        void whenTokenValid_thenReturns200() throws Exception {
            ...
            mockMvc.perform(get(BASE_URL + "/profile")
                    ...
                    .andExpect(jsonPath("$.email").value("gibekkk@moodbites.com"))
    ...
    class EditProfile {
        ...
        void whenTokenValid_thenReturns200() throws Exception {
            ...
            updatedUser.setEmail("gibekkk@moodbites.com");
