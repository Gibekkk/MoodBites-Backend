...
// import com.moodbites.restfulapi.dto.ProfilDTO;
...
// import com.moodbites.restfulapi.service.LoginService;
...
// import com.moodbites.restfulapi.model.enums.Level;
...
//             Optional<User> loginOpt = otpService.verifyOTP(verifyOTPDTO.getLoginId(), verifyOTPDTO.getOtp());
...
//         HTTPCode httpCode = HTTPCode.OK;
//         try {
//             Optional<User> loginOpt = loginService.findLoginById(loginId);
//             if (loginOpt.isPresent()) {
//                 User login = loginOpt.get();
